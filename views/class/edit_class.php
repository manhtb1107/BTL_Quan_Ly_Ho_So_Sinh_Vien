...
<body>
    <div class="container mt-3">
        ...
        <?php
            ...
            $gradeInfo = handleGetClassById($id);
            ...
            $classInfo = $gradeInfo; // Rename for clarity
                            ...
                            <form action="../../handle/class_process.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="class_code" name="class_code" 
                                           value="<?= htmlspecialchars($classInfo['class_code'] ?? '') ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="class_name" class="form-label">Tên lớp</label>
                                    <input type="text" class="form-control" id="class_name" name="class_name" 
                                           value="<?= htmlspecialchars($classInfo['class_name'] ?? '') ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="major" class="form-label">Ngành học</label>
                                    <input type="text" class="form-control" id="major" name="major" 
                                           value="<?= htmlspecialchars($classInfo['major'] ?? '') ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="academic_year" class="form-label">Niên khóa</label>
                                    <input type="text" class="form-control" id="academic_year" name="academic_year" 
                                           value="<?= htmlspecialchars($classInfo['academic_year'] ?? '') ?>" required>
                                </div>

                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="../class.php" class="btn btn-secondary me-md-2">Hủy</a>
