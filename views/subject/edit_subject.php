...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: ../subject.php?error=Không tìm thấy môn học");
    exit;
}
...
<head>
    ...
    <title>Chỉnh sửa Môn học - Admin Panel</title>
        ...
        <main class="main-content">
            ...
            <header class="top-header">
                <div class="header-left">
                    ...
                    <h2 class="page-title mb-0">Chỉnh sửa Môn học</h2>
                </div>
                ...
                <div class="form-card">
                    <div class="form-header">
                        ...
                        <div class="form-header-content">
                            <h2>Chỉnh sửa thông tin môn học</h2>
                            <p>Cập nhật thông tin chi tiết của môn học</p>
                        </div>
                    </div>
                    ...
                    <form action="../../handle/subject_process.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="credits" 
                                   name="credits" 
                                   value="<?= htmlspecialchars($subject['credits'] ?? '') ?>"
                                   min="1"
                                   max="10"
                                   placeholder="Ví dụ: 3"
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <select id="major_id" name="major_id" class="form-select" required>
                                ...
                                <?php foreach ($majors as $major): ?>
                                    <option value="<?= $major['id'] ?>" <?= (isset($subject['major_id']) && $subject['major_id'] == $major['id']) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select id="subject_type" name="subject_type" class="form-select" required>
                                ...
                                <option value="Bắt buộc" <?= (isset($subject['subject_type']) && $subject['subject_type'] == 'Bắt buộc') ? 'selected' : '' ?>>Bắt buộc</option>
                                <option value="Tự chọn" <?= (isset($subject['subject_type']) && $subject['subject_type'] == 'Tự chọn') ? 'selected' : '' ?>>Tự chọn</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Nhập mô tả về môn học..."><?= htmlspecialchars($subject['description'] ?? '') ?></textarea>
                        </div>
