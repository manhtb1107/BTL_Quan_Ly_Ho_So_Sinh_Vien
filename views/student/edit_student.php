...
<head>
    <title>Chỉnh sửa thông tin sinh viên - Quản lý hồ sơ sinh viên đại học</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h3 class="mt-3 mb-4">
                    <i class="fas fa-user-edit"></i> CHỈNH SỬA THÔNG TIN SINH VIÊN
                </h3>
        <?php
                                        ...
                                        <select class="form-select" id="major" name="major">
                                            ...
                                            <?php foreach ($majors as $major): ?>
                                                <option value="<?php echo htmlspecialchars($major['major_name']); ?>"
                                                    <?php echo ($student['major'] ?? '') == $major['major_name'] ? 'selected' : ''; ?>>
