...
<head>
    ...
    <title>Chỉnh sửa Sinh viên - Admin Panel</title>
...
<body>
        ...
        <main class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <h2 class="page-title mb-0">Chỉnh sửa Sinh viên</h2>
                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($student['image'])): ?>
                                            <div class="mb-2 text-center">
                                                <img src="/baitaplon1/<?= htmlspecialchars($student['image']) ?>" 
                                                     alt="Ảnh hiện tại" 
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="id_card" name="id_card"
                                            value="<?php echo htmlspecialchars($student['id_card'] ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="hometown" name="hometown" rows="2"><?php echo htmlspecialchars($student['hometown'] ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <select class="form-select" id="major" name="major">
                                            ...
                                            <?php foreach ($majors as $major): ?>
                                                <option value="<?php echo intval($major['id']); ?>"
                                                    <?php echo (isset($student['major']) && intval($student['major']) == intval($major['id'])) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status">
                                            <option value="Đang học" <?php echo ($student['status'] ?? '') == 'Đang học' ? 'selected' : ''; ?>>Đang học</option>
                                            <option value="Tạm nghỉ" <?php echo ($student['status'] ?? '') == 'Tạm nghỉ' ? 'selected' : ''; ?>>Tạm nghỉ</option>
                                            <option value="Tốt nghiệp" <?php echo ($student['status'] ?? '') == 'Tốt nghiệp' ? 'selected' : ''; ?>>Tốt nghiệp</option>
                                            <option value="Bị đuổi học" <?php echo ($student['status'] ?? '') == 'Bị đuổi học' ? 'selected' : ''; ?>>Bị đuổi học</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3" id="graduation_date_container" style="display: none;">
                                        ...
                                        <input type="date" class="form-control" id="graduation_date" name="graduation_date"
                                            value="<?php echo htmlspecialchars($student['graduation_date'] ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        // Kích hoạt kiểm tra trạng thái khi tải trang
        document.addEventListener('DOMContentLoaded', function() {
            const statusSelect = document.getElementById('status');
            if (statusSelect.value === 'Tốt nghiệp') {
                document.getElementById('graduation_date_container').style.display = 'block';
