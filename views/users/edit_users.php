...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: ../users.php?error=Không tìm thấy người dùng");
    exit;
}
        ...
        <main class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <h2 class="page-title mb-0">Chỉnh sửa Người dùng</h2>
                </div>
                ...
                <div class="form-card">
                    <div class="form-header-simple">
                        ...
                        <div class="content">
                            ...
                            <p>Cập nhật thông tin và phân quyền</p>
                        </div>
                    </div>
                    ...
                    <form action="../../handle/users_process.php" method="POST">
                        ...
                        <div class="info-note">
                            ...
                            <strong>Thay đổi mật khẩu:</strong> Để trống nếu không muốn thay đổi mật khẩu
                        </div>
                        ...
                        <div class="form-group-simple">
                            ...
                            <select id="role" name="role" required>
                                ...
                                <option value="teacher" <?= $user['role'] === 'teacher' ? 'selected' : '' ?>>Teacher (Giảng viên)</option>
                            </select>
                        </div>
